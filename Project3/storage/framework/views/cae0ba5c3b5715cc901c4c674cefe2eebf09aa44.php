<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid col-md-10 col-md-offset-1">
        <div class="row" style="justify-content: space-evenly;" id="courses">
            <?php $__currentLoopData = $data_science; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4 courses-style bg-white d-flex align-items-center" style="max-width: 30%">
                    <a class="col-md-12 text-decoration-none text-danger font-weight-bolder" href="<?php echo e(URL::to('tutorials')); ?>/<?php echo e($data->technology_name); ?>">
                        <img class="img-fluid mr-2" style="width:50px;" src="<?php echo e($data->img); ?>" />
                        <?php echo e($data->technology_name); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nikola/code/brainsterprojectsnikolanajdovb1/project3/resources/views/categories/data_science.blade.php ENDPATH**/ ?>