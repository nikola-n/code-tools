        ...
        <div class="row" style="justify-content: space-evenly;" id="courses">
            @foreach($devOps as $dev)
                <div class="col-md-4 courses-style bg-white d-flex align-items-center" style="max-width: 30%">
                    <a class="col-md-12 text-decoration-none text-danger font-weight-bolder" href="{{URL::to('tutorials')}}/{{$dev->technology_name}}">
                        <img class="img-fluid mr-2" style="width:50px;" src="{{$dev->img}}" />
                        {{$dev->technology_name}}
                    </a>
                </div>
            @endforeach
